const RestrictedPersonsView = () => {
  return (
    <div className="w-[170vh] ml-60 mb-10 border border-black rounded-3xl p-4">
      <h1 className="font-semibold text-xl mb-20">Restricted Person Alerts</h1>

      <div className="">
        <div className="flex flex-col space-y- ml-10 mb-10 ">
          <img className="w-20 h-20 " src="src/assets/red.svg" />
          <span className="font-bold text-2xl ml-8">4</span>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="table-auto border-collapse border border-black w-full text-sm text-left text-gray-600">
            <thead className="bg-black text-white">
              <tr>
                <th className="border  border-black px-4 h-20 py-2">R ID</th>
...
export default RestrictedPersonsView;
